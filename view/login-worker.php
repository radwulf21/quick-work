...
<head>
    ...
    <title>Quick Work - Login do trabalhador</title>
...
<body id="page-login">
    <div id="container">
        ...
        <form action="../controller/loginTrabalhador.php" method="POST">
            ...
            <button class="button button-login-worker" type="submit">
                Entrar
            </button>

            <hr>

            <a class="button button-create-account" href="register-worker.php">
                Criar nova conta
            </a>
        </form>
    </div>
